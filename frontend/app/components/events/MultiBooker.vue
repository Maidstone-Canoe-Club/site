  ...
  <div>
    ...
    >
      <div class="flex gap-1 flex-wrap justify-between items-center mb-4">
        ...
        >Who do you want to book onto the event?</span>
      </div>
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
              ...
              <input-toggle
                ...
                :disabled="isFull && !selectedUserIds.has(u.id)"
                @update:model-value="val => {
                  if (val) selectedUserIds.add(u.id)
...
const usersToBook = computed(() => usersThatCanBook.value.filter(u => selectedUserIds.value.has(u.id)));
